...
import TechShop.JoseDaniel.domain.Item;
import TechShop.JoseDaniel.domain.Factura;
import TechShop.JoseDaniel.domain.Usuario;
import TechShop.JoseDaniel.service.CarritoService;
import TechShop.JoseDaniel.service.FacturaService;
...
public class CarritoController {
    ...
    // --- 4. CARGAR VISTA PARA MODIFICAR CANTIDAD ---
    ...
    public String modificar(
        ...
        if (item == null) {
            System.out.println("Hubo problemas al buscar el ítem.");
            return "redirect:/carrito/listado";
        }

        // 3. Pasar el ítem encontrado al modelo
        model.addAttribute("item", item);

        // 4. Retornar la vista de modificación
        return "/carrito/modifica";
    }

    // --- 5. ACTUALIZAR CANTIDAD DESDE LA VISTA ---
    ...
    public String facturarCarrito(HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            // 4. Redirigir a la vista de la factura
    ...
    public String verFactura(@ModelAttribute("idFactura") Integer idFactura, Model model) {
        ...
        // Obtener la factura completa con sus ventas
