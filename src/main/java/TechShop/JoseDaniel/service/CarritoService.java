...
import TechShop.JoseDaniel.domain.*;
import TechShop.JoseDaniel.repository.FacturaRepository;
import TechShop.JoseDaniel.repository.ProductoRepository;
import TechShop.JoseDaniel.repository.VentaRepository;
...
public class CarritoService {
    ...
    public Factura procesarCompra(List<Item> carrito, Usuario usuario) {
        ...
        // 2. CREAR Y PERSISTIR LÍNEAS DE VENTA Y ACTUALIZAR STOCK
